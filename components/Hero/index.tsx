...
const Hero = ({ pageInfo }: Props) => {
    ...
    const links = [
        {
            name: 'home', svg: (
                <svg className=' stroke-[#ccc] h-[1.2em] w-[1.2em]' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor" >
        ...
        {
            name: 'skills', svg: (
                <svg className='peer-hover:stroke-white stroke-[#ccc] h-[1.2em] w-[1.2em]' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
        ...
        {
            name: 'projects', svg: (
                <svg className='hover:stroke-white stroke-[#ccc]  h-[1.2em] w-[1.2em]' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor"  >
