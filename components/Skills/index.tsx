...
const Skills = ({ skills }: Props) => {
  return (
    <motion.section
      ...
      id='skills'
      layout='position'
      className='bg-[#eba7a7] snap-center xl:space-y-0 mx-auto items-center justify-center min-h-screen flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] px-10 flex-shrink-0'>
      <motion.h3
